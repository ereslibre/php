...
EXEEXT =
CC = /php/wasi-sdk-16.0/bin/clang --sysroot=/php/wasi-sysroot -D_WASI_EMULATED_MMAN=1 -D_WASI_EMULATED_SIGNAL=1 -D_WASI_EMULATED_PROCESS_CLOCKS=1 -D_WASI_EMULATED_GETPID=1 -D_POSIX_SOURCE=1 -D_GNU_SOURCE=1 -DHAVE_FORK=0 -DSQLITE_OMIT_LOAD_EXTENSION=1 -DSQLITE_MUTEX_OMIT=1 -DSQLITE_ENABLE_LOCKING_STYLE=0 -DSQLITE_OMIT_DISKIO=1 -DSQLITE_OMIT_WAL=1 -DSQLITE_OMIT_PAGER_PRAGMAS=1
